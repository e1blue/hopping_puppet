...
static void init(struct popupCartridgeTopManual *this){
	...
	// テクスチャロード
	this->e3dIdManualImage = engineGraphicObjectTexCreate("img/manual.png", ENGINEGRAPHICOBJECTTEXTYPE_LINEAR);
}
...
static void dispose(struct popupCartridgeTopManual *this){
	...
	engineGraphicObjectTexDispose(this->e3dIdManualImage);
